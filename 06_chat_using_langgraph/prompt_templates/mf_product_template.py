...
For Conservative risk tolerance: Prefer funds with volatility under 10% for stable returns
For Moderate risk tolerance: Can accept volatility between 10-20% for balanced growth
For Aggressive risk tolerance: Can handle volatility above 20% for higher potential returns

Investment horizon impact:

Short Term: Lower volatility (< 10%) recommended
Medium Term: Moderate volatility (10-15%) acceptable
Long Term: Higher volatility (> 15%) can be considered for better returns
...
Critical for income ranges "Below ₹50,000" for capital preservation

For Moderate investors:

Acceptable Sharpe ratio range: -3.0 - -1.0
Balanced approach for "Wealth Creation" and "Tax Saving" goals
Suitable for income range "₹50,000 - ₹1,00,000"
...
More relevant for income range "Above ₹1,00,000"
...
"Regular Income": Target stable CAGR of 5-8%
"Tax Saving": Minimum CAGR of 6-10%
"Wealth Creation": Higher CAGR potential of 10%+
"Retirement": Based on risk tolerance, typically 6-12%

Risk Tolerance impact:

Conservative: Focus on consistent 6-8% CAGR
Moderate: Aim for 8-12% CAGR
Aggressive: Target 12%+ CAGR
...
Conservative: Stable 7-9% CAGR
Moderate: Target 9-13% CAGR
Aggressive: Seek 13%+ CAGR
